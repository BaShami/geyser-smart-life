...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Affordable WhatsApp Smart Home Control | GeyserBrain" },
      { name: "description", content: "GeyserBrain installs affordable smart controllers for lights, geysers, plugs and other home devices — all controlled from WhatsApp. Start with one device and add more when you are ready." },
      { name: "author", content: "GeyserBrain" },
      { property: "og:title", content: "Affordable WhatsApp Smart Home Control | GeyserBrain" },
      { property: "og:description", content: "Control lights, geysers, plugs and more from WhatsApp. Start with one device and expand later. Installation arranged where available." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Affordable WhatsApp Smart Home Control | GeyserBrain" },
      { name: "twitter:description", content: "Control lights, geysers, plugs and more from WhatsApp. Start with one device and expand later." },
